    ...
    <div className="flex flex-col min-h-screen bg-background text-text-primary">
      ...
      <aside aria-label="DNST Announcement" className="border-b border-border bg-surface py-2.5 px-4 text-xs">
        <div className="container mx-auto max-w-6xl flex flex-wrap items-center justify-center gap-2 text-center text-text-secondary">
          <span className="font-bold text-accent uppercase tracking-widest text-[10px] inline-flex items-center gap-1">
            <Sparkles className="w-3.5 h-3.5" /> DNST 2025
          </span>
          ...
          <Link
            href="/dnst/register"
            className="text-accent hover:text-accent-dark font-semibold inline-flex items-center group ml-1 transition-colors duration-150 ease-out"
          >
            Register Now <ArrowRight className="w-3 h-3 ml-1 group-hover:translate-x-0.5 transition-transform duration-200 ease-out" />
          </Link>
        </div>
      </aside>
      ...
      <section className="border-b border-border bg-background pt-10 pb-12 md:pt-16 md:pb-18">
        <div className="container mx-auto max-w-4xl px-4 flex flex-col items-center text-center">
          ...
          {/* Regional Eyebrow */}
          <FadeIn delay={0.02} className="mb-3 md:mb-4">
          ...
          <FadeIn delay={0.1} className="max-w-2xl mb-8">
          ...
          <FadeIn delay={0.14} className="w-full max-w-2xl mb-8 text-left">
            <div className="border border-border bg-[linear-gradient(135deg,#FFFDF8_0%,#FAF0E2_45%,#FCE5D6_100%)] p-5 sm:p-7 shadow-[0_4px_24px_-6px_rgba(36,33,29,0.07)]">
              ...
              <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3">
                <Link href="/dnst/register" className="w-full sm:w-auto group">
                  ...
                  >
                    Register for DNST <ArrowRight className="w-3.5 h-3.5 ml-1.5 group-hover:translate-x-0.5 transition-transform duration-200 ease-out" />
                  </Button>
                </Link>
                <Link href="/dnst" className="w-full sm:w-auto">
                  <Button
                    size="default"
                    variant="outline"
                    className="h-11 px-5 text-xs sm:text-sm border-border text-text-primary hover:bg-surface-secondary font-medium rounded-none w-full sm:w-auto shadow-none transition-colors duration-150 ease-out"
                  >
          ...
          <FadeIn delay={0.18} className="flex flex-wrap items-center justify-center gap-4 text-xs sm:text-sm text-text-secondary pt-2">
            <span>Looking for regular coaching?</span>
            <Link href="/programs" className="text-text-primary hover:text-accent font-semibold inline-flex items-center group transition-colors duration-150 ease-out">
              View All Programs <ArrowRight className="w-3.5 h-3.5 ml-1 group-hover:translate-x-0.5 transition-transform duration-200 ease-out" />
            </Link>
            <span className="text-border-strong hidden sm:inline">·</span>
            <Link href="/contact" className="text-text-primary hover:text-accent font-semibold transition-colors duration-150 ease-out">
              Book Free Demo
            </Link>
          </FadeIn>
      ...
      <section className="border-b border-border bg-surface-secondary py-8 md:py-12">
        <div className="container mx-auto max-w-5xl px-4">
          <FadeIn>
            <div className="border border-border bg-surface group overflow-hidden">
              <div className="overflow-hidden">
                <Image
                  ...
                  width={1920}
                  height={700}
                  className="w-full h-[220px] sm:h-[320px] md:h-[420px] object-cover object-center transition-transform duration-500 ease-out group-hover:scale-[1.008]"
                  priority
                />
              </div>
        ...
        <div className="container mx-auto max-w-5xl">
          <div className="grid grid-cols-2 md:grid-cols-4 divide-x divide-y md:divide-y-0 divide-border">
            {[
              ...
              <FadeIn key={i} delay={0.04 * i} className="p-6 md:p-8 text-center">
        ...
        <div className="container mx-auto px-4 max-w-5xl">
          ...
          <FadeIn delay={0.06}>
            <div className="border border-border bg-surface grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 divide-y sm:divide-y-0 sm:divide-x divide-border">
              {[
                ...
                return (
                  <div key={i} className="p-6 space-y-2.5 transition-colors duration-200 ease-out hover:bg-surface-secondary/40">
          ...
          <FadeIn delay={0.1}>
            <div className="mt-6 p-4 sm:p-5 border border-border bg-surface flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 text-xs sm:text-sm">
              ...
              <Link
                href="/dnst/syllabus"
                className="text-accent hover:text-accent-dark font-semibold inline-flex items-center shrink-0 uppercase text-xs tracking-wider group transition-colors duration-150 ease-out"
              >
                View Syllabus <ArrowRight className="w-3.5 h-3.5 ml-1 group-hover:translate-x-0.5 transition-transform duration-200 ease-out" />
              </Link>
            </div>
          </FadeIn>
      ...
      <section id="programs" className="py-16 md:py-24 border-b border-border bg-background">
        <div className="container mx-auto px-4 max-w-5xl">
            ...
            <div className="border border-border bg-surface divide-y divide-border">
              {[
                ...
                <Link 
                  key={i}
                  href={prog.href}
                  className="group p-6 md:p-8 flex flex-col md:flex-row md:items-center justify-between hover:bg-surface-secondary transition-colors duration-200 ease-out cursor-pointer block"
                >
                  <div className="md:w-3/4 mb-3 md:mb-0 space-y-2">
                    ...
                    <h3 className="text-2xl md:text-3xl font-serif text-text-primary group-hover:text-accent transition-colors duration-200 ease-out">
                      {prog.title}
                    </h3>
                  ...
                  <div className="md:w-1/4 flex justify-start md:justify-end">
                    <ArrowDownRight className="w-7 h-7 text-text-muted group-hover:text-accent group-hover:translate-x-0.5 group-hover:translate-y-0.5 transition-all duration-200 ease-out" />
                  </div>
                </Link>
              ))}
            </div>
          ...
          <FadeIn delay={0.1} className="mt-8 text-center">
            <Link
              href="/programs"
              className="text-xs font-bold uppercase tracking-widest text-text-primary hover:text-accent transition-colors duration-150 ease-out inline-flex items-center group"
            >
              View Full Programs Catalog <ArrowRight className="ml-1.5 h-3.5 w-3.5 group-hover:translate-x-0.5 transition-transform duration-200 ease-out" />
            </Link>
          </FadeIn>
      ...
      <section className="py-16 md:py-24 border-b border-border bg-background">
        <div className="container mx-auto px-4 max-w-5xl">
          <div className="grid lg:grid-cols-12 gap-10 lg:gap-14">
            ...
            <FadeIn delay={0.08} className="lg:col-span-7 border-t border-border divide-y divide-border">
              {[
                ...
                <div key={i} className="py-5 space-y-1.5 transition-colors duration-200 ease-out">
          ...
          <FadeIn delay={0.06}>
            <div className="border border-border bg-surface grid grid-cols-1 md:grid-cols-3 divide-y md:divide-y-0 md:divide-x divide-border">
              {[
                ...
                <div key={i} className="p-6 md:p-8 space-y-3 transition-colors duration-200 ease-out hover:bg-surface-secondary/40">
        ...
        <div className="container mx-auto px-4 max-w-4xl text-center">
          <FadeIn className="space-y-4">
            ...
            <div className="pt-2">
              ...
              >
                Explore Gulf Programs <ArrowRight className="w-3.5 h-3.5 ml-1.5 group-hover:translate-x-0.5 transition-transform duration-200 ease-out" />
              </Link>
            </div>
          </FadeIn>
        </div>
          ...
          <FadeIn className="space-y-5">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-3 pt-3">
              ...
              <Link href="/contact" className="w-full sm:w-auto">
                <Button size="lg" variant="outline" className="h-11 md:h-12 px-7 text-sm md:text-base border-border text-text-primary hover:bg-surface font-medium rounded-none w-full sm:w-auto shadow-none transition-colors duration-150 ease-out">
                  Book Free Demo
                </Button>
              </Link>
            </div>
